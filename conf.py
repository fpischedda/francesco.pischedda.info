...
BLOG_AUTHOR = "Francesco \"fpsd\" Pischedda"  # (translatable)
BLOG_TITLE = "@FPSD"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://francesco.pischedda.info/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://francesco.pischedda.info/"
BLOG_EMAIL = "francesco@pischedda.info"
BLOG_DESCRIPTION = "random.choice(['programming', 'gaming', 'stuff'])"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/pages/services/', 'Hire me!', 'icon-user'),
        ('https://github.com/fpischedda', 'My Github', 'icon-github'),
        ('https://twitter.com/focaskater', 'Twitter', 'icon-twitter'),
        ('https://getnikola.com', 'Powered By Nikola', ''),
    ),

    "it": (
        ('/it/index.html', 'Home', 'icon-home'),
        ('/it/archive.html', 'Archives', 'icon-folder-open-alt'),
        ('/it/categories/index.html', 'Tags', 'icon-tags'),
        ('/it/rss.xml', 'RSS', 'icon-rss'),
        ('/pages/services/', 'Hire me!', 'icon-user'),
        ('https://github.com/fpischedda', 'My Github', 'icon-github'),
        ('https://twitter.com/focaskater', 'Twitter', 'icon-twitter'),
        ('https://getnikola.com', 'Powered By Nikola', ''),
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -azP output/ blog:sites/francesco.pischedda.info",
    ]
}
